...
- [x] T045 Run full quickstart.md validation against a real ESPN account (3 real leagues for SC-002/SC-003), record results in `specs/001-league-onboarding/quickstart-results.md`
